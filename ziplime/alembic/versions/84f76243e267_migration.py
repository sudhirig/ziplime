...
Revision ID: 84f76243e267
Revises: 
Create Date: 2025-03-31 18:42:18.286968
...
def upgrade():
    ...
    op.create_index(op.f('ix_equities_exchange'), 'equities', ['exchange'], unique=False)
    ...
    sa.Column('start_date', sa.Date(), nullable=False),
    sa.Column('end_date', sa.Date(), nullable=False),
    sa.ForeignKeyConstraint(['sid'], ['assets.sid'], ),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_equities_exchange'), table_name='equities')
