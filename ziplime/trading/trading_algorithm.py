...
#     async def order(self, asset: Asset, amount: float, style: ExecutionStyle, exchange_name: str | None = None) -> Order | None:
...
#         )
#
#     def _calculate_order_percent_amount(self, asset: Asset, percent: float):
