...
Revision ID: 887327adfe53
Revises: 
Create Date: 2025-04-06 03:51:52.497816
...
def upgrade():
    ...
    sa.Column('base_asset_sid', sa.Integer(), nullable=False),
    sa.Column('quote_asset_sid', sa.Integer(), nullable=False),
    sa.Column('exchange', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['base_asset_sid'], ['asset_router.sid'], ),
    sa.ForeignKeyConstraint(['exchange'], ['exchanges.exchange'], ),
    sa.ForeignKeyConstraint(['quote_asset_sid'], ['asset_router.sid'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_trading_pair_base_asset_sid'), 'trading_pair', ['base_asset_sid'], unique=False)
    op.create_index(op.f('ix_trading_pair_exchange'), 'trading_pair', ['exchange'], unique=False)
    op.create_index(op.f('ix_trading_pair_quote_asset_sid'), 'trading_pair', ['quote_asset_sid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_trading_pair_quote_asset_sid'), table_name='trading_pair')
    op.drop_index(op.f('ix_trading_pair_exchange'), table_name='trading_pair')
    op.drop_index(op.f('ix_trading_pair_base_asset_sid'), table_name='trading_pair')
